...
-- Chọn vùng
createBtn("🎯 Chọn", UDim2.new(0.05, 0, 0, 60), function()
...
-- Reset
createBtn("🗑 Reset", UDim2.new(0.55, 0, 0, 60), function()
	clickX = 0
	clickY = 0
	status.Text = "📍 Đã reset vị trí!"
end, Color3.fromRGB(150, 60, 60))

-- Tăng tốc
createBtn("➕", UDim2.new(0.05, 0, 0, 95), function()
	delay = math.max(0.01, delay - 0.01)
	status.Text = "⏱ Tốc độ: " .. string.format("%.2fs", delay)
end, Color3.fromRGB(60, 120, 60))

-- Giảm tốc
createBtn("➖", UDim2.new(0.55, 0, 0, 95), function()
	delay += 0.01
	status.Text = "⏱ Tốc độ: " .. string.format("%.2fs", delay)
end, Color3.fromRGB(60, 120, 60))

-- Bật / Tắt auto click (giữa)
...
toggleBtn.MouseButton1Click:Connect(function()
	...
	if isClicking then
		status.Text = "🔁 Auto click tại: " .. clickX .. ", " .. clickY
...
discordBtn.Position = UDim2.new(1, -35, 1, -35)
...
discordBtn.MouseButton1Click:Connect(function()
	...
	status.Text = "✅ Đã copy link Discord!"
end)